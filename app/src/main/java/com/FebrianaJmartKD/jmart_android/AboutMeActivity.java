...
import com.FebrianaJmartKD.jmart_android.request.RegisterRequest;
import com.FebrianaJmartKD.jmart_android.request.RegisterStoreRequest;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTopUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String URL = "http://10.0.2.2:8086/account/"+LoginActivity.getLoggedAccount().id+"/topUp";
